                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-category" style="height: 220px;">
                            ...
                            <ul>
                                ...
                                <li><a href="{{ route('product.show',$product_cat->id) }}">{{ $product_cat->name }}</a></li>
                            ...
                            <div class="images">
                                <img src="{{ $cat->getImmageUrlAttribute() }}" style="height: 180px; width: 180px;" alt="#">
                            </div>
                        </div>
                        <!-- End Single Category -->
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                @foreach ($Products as $Product)
                    <div class="col-lg-3 col-mg-4 col-sm-12">
                        <div class="single-product">
                            <div class="product-image">
                                <img style="height: 270px" src="{{ $Product->immage_url }}" alt="#">
                            ...
                            <div class="product-info">
                                <span class="category">{{ $Product->cats1->name }}</span>
                                <h4 class="title">
                                ...
                                <div class="price">
                                    <span>$199.00</span>
                                    <span class="discount-price"> ${{ $Product->sale_percent }} </span>
                                </div>
                            </div>
                        </div>
                    </div>
