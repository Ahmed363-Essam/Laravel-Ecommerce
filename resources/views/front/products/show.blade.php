                            ...
                            <main id="gallery">
                                <div class="main-img">
                                    <img style="width: 1000px;height: 450px;"
                                        src="{{ $product->getImmageUrlAttribute() }}" id="current" alt="#">
                                </div>
                                <div class="images">
                        ...
                        <form action="{{ route('cart.store') }}" method="post">
                            ...
                            <div class="product-info">
                                ...
                                <p class="category"><i class="lni lni-tag"></i> Drones:<a
                                        href="javascript:void(0)">{{ $product->cats1->name }}</a></p>
                                <h3 class="price">${{ $product->price }}<span>${{ $product->sale_percent }}</span></h3>
