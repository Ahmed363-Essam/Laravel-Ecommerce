<x-front-layout title='check card'>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Country</label>
                                                    <div class="form-input form">
                                                        <select class="form-control" name="addr[billing][country]" id="">
                                                            <option value="" hidden> choose the country </option>
                                                            @foreach ($Countries as $key => $value)
                                                                <option value="{{ $key }}">{{ $value }}</option>
                                                            @endforeach
                                                        </select>
                                                       <!-- <input type="text" name="addr[billing][country]" placeholder="Country"> -->
                                                    </div>
                                                </div>
                                            </div>
                                           ...
                                           <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Country</label>
                                                    <div class="form-input form">
                                                        <select class="form-control" name="addr[shipping][country]" id="">
                                                            <option value="" hidden> choose the country </option>
                                                            @foreach ($Countries as $key => $value)
                                                                <option value="{{ $key }}">{{ $value }}</option>
                                                            @endforeach
                ...
                <div class="col-lg-4">
                    <div class="checkout-sidebar">
                        ...
                        <div class="checkout-sidebar-price-table mt-30">
                            ...
                            @foreach ($cart1->get() as $item1)
                            <div class="sub-total-price">
                    
                                <div class="total-price">
                                    <p class="value">{{ $item1->product->name }}:</p>
                                    <p class="price">${{ $item1->product->price * $item1->quantity }}</p>
                                </div>
